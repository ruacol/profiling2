...
GO
ALTER PROCEDURE [dbo].[PRF_SP_PersonMerge_NHibernate]                                    
(                                    
 @ToKeepPersonID INT,                                  
...
BEGIN                  
 ...
 BEGIN TRY                                    
  BEGIN TRANSACTION                                  
     ...
     UPDATE PS                  
     SET PS.[PersonID] = @ToKeepPersonID                  
     FROM [dbo].[PRF_PersonSource] AS PS                  
     WHERE PS.[PersonID] = @ToDeletePersonID                  
     AND NOT EXISTS                  
     (                  
      SELECT 'X' FROM [dbo].[PRF_PersonSource] AS A                  
      WHERE A.[PersonID] = @ToKeepPersonID                  
      AND A.[SourceID] = PS.[SourceID]                  
     )    
	 ...
	 UPDATE [dbo].[PRF_PersonRestrictedNote] SET [PersonID] = @ToKeepPersonID WHERE [PersonID] = @ToDeletePersonID  
