...
GO
ALTER PROCEDURE [dbo].[SCR_SP_RequestGet]                              
(                        
 @UserID NVARCHAR(450),                              
 @RequestID INT = NULL,    
 @IsValidator BIT = 0,    
...
BEGIN                              
 ...
 SELECT                              
  ...
  ISNULL(R.[RespondBy],'') AS [RespondBy],                      
  R.[RespondImmediately] AS [RespondImmediately],
 ...
 (                  
  ...
  OR @IsValidator = 1 OR @IsAggregator = 1 OR @IsSmg = 1          
 )                      
